# FEC orphan attribution — prod — 2026-09-05

Read-only enumeration for FIX-930. Row-level detail: `2026-09-05-fec-orphan-attribution.tsv`.
...
- platform-wide donation money on officials: $9,504,614,063 across 7,713 officials → suspects are **0.1%** of official-attributed donation dollars
...
|---|---|---|---:|:-:|
| Shontel M. Brown → Sherrod Brown | CROSS-PERSON MISATTRIBUTION | CLEARED (residual overlap 272 pairs, frac 0.0755 < cut 0.1667; keeps its own $6,637,223) | 272 | ✓ |
| Jon Ossoff (elected) → Ossoff (candidate) | SAME-PERSON DUPLICATE | MERGED (holds $88,404,802, carries its CAND_ID, no rival claim) | — | ✓ |
