# FEC orphan attribution — prod — 2026-07-31

Read-only enumeration for FIX-930. Row-level detail: `2026-07-31-fec-orphan-attribution.tsv`.
...
- platform-wide donation money on officials: $4,832,843,124 across 4,337 officials → suspects are **2.8%** of official-attributed donation dollars
...
|---|---|---|---:|:-:|
| Shontel M. Brown → Sherrod Brown | CROSS-PERSON MISATTRIBUTION | CROSS-PERSON MISATTRIBUTION | 42682 | ✓ |
| Jon Ossoff (elected) → Ossoff (candidate) | SAME-PERSON DUPLICATE | MERGED (holds $15,645,810, carries its CAND_ID, no rival claim) | — | ✓ |

## Top suspects by dollars

| official | tier | branch | rows | dollars | window | twin | shared |
|---|---|---|---:|---:|---|---|---:|
| Shontel M. Brown | elected | CROSS-PERSON MISATTRIBUTION | 43,960 | $50,998,289 | 2018-10-17→2026-03-31 | Sherrod Brown (S6OH00163) | 42,682 |
...
| Mike Collins | elected | CROSS-PERSON MISATTRIBUTION | 1,534 | $3,496,690 | 2019-01-22→2026-03-31 | Michael Collins (S6GA00390) | 756 |
