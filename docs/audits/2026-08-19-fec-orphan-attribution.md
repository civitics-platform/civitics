# FEC orphan attribution — prod — 2026-08-19

Read-only enumeration for FIX-930. Row-level detail: `2026-08-19-fec-orphan-attribution.tsv`.
...
- platform-wide donation money on officials: $9,330,970,670 across 7,682 officials → suspects are **0.1%** of official-attributed donation dollars
...
|---|---|---|---:|:-:|
| Shontel M. Brown → Sherrod Brown | CROSS-PERSON MISATTRIBUTION | CLEARED (residual overlap 267 pairs, frac 0.0742 < cut 0.1667; keeps its own $6,606,505) | 267 | ✓ |
| Jon Ossoff (elected) → Ossoff (candidate) | SAME-PERSON DUPLICATE | MERGED (holds $78,791,661, carries its CAND_ID, no rival claim) | — | ✓ |
