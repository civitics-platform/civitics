...
// proposal detail page. Left in place per the no-delete rule; remove in a
// later cleanup PR.
...
interface CivicCommentsProps {
  proposalId: string;
}

export function CivicComments({ proposalId }: CivicCommentsProps) {
          ...
          {comments.map((comment) => (
            ...
            >
              <div className="flex items-center justify-between gap-2 mb-2">
                ...
                <FlagButton contentType="civic_comment" contentId={comment.id} />
              </div>
