    ...
    <div className="min-h-screen bg-paper">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 space-y-2">
          <div className="h-5 w-32 animate-pulse bg-rule/50" />
          <div className="h-9 w-3/4 animate-pulse bg-rule/50" />
          <div className="flex gap-2">
            <div className="h-6 w-20 animate-pulse bg-rule/50" />
            <div className="h-6 w-24 animate-pulse bg-rule/50" />
          </div>
        </div>
