...
export function Footer() {
  ...
  return (
    // border-rule-strong == border-ink in paper mode; it only diverges inside
    // the terminal scope the chrome now joins on /dashboard + /search
    // (FIX-1096), where a near-white double rule would glare.
    <footer className="mt-auto border-t-[3px] border-double border-rule-strong bg-paper">
